...
import ContactImg from '../Assets/laptop.jpeg';

const Contact = () => {
  return (
    <div id='contact' className='w-full text-white bg-[#254f8d]'>
        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2'>Hashim Jasem</h2>
              ...
              <div>
                ...
                <div className='flex items-center justify-between py-4'>
                  <a
                    href='https://www.linkedin.com/in/hashim-jasem-b2703924a/'
                    target='_blank'
                    rel='noreferrer'
                  >
                  ...
                  <a
                    href='https://github.com/Hashimjasem'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <div className='rounded-full shadow-lg p-6 cursor-pointer hover:scale-110 ease-in duration-300'>
